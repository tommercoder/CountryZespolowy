...
public class adapterAllpresidents extends FirebaseRecyclerAdapter<model, adapterAllpresidents.myviewholder>
{
    ...
    public adapterAllpresidents(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
