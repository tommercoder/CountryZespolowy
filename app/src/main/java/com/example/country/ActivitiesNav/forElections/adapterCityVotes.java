...
public class adapterCityVotes extends FirebaseRecyclerAdapter<model, adapterCityVotes.myviewholder>
{
    ...
    public adapterCityVotes(@NonNull FirebaseRecyclerOptions<model> options) {
        super(options);
