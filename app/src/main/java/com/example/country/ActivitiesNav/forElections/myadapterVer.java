...
public class myadapterVer extends FirebaseRecyclerAdapter<model, myadapterVer.myviewholder>
{
            ...
            public void onClick(final View view) {
                ...
                reff_users.child(user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {//data from current user
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        final String voted = snapshot.child("votedVer").getValue().toString();


                            final String city = snapshot.child("city").getValue().toString();///city of current user
                            final DatabaseReference reff = FirebaseDatabase.getInstance().getReference("VerkhovnaRadaParties");//reff to candidates
                        ...
                        reff.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                               ...
                               String info = snapshot.child(number).getValue().toString();//data of clicked city candidate
                                String name = snapshot.child(number).child("party").getValue().toString();
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.verdesign,parent,false);
